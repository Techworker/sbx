...
const SignedOperation = require('@pascalcoin-sbx/json-rpc').Types.SignedOperation;
...
describe('Core.Types.SignedOperation', () => {
  it('can be created from raw and contains valid values', () => {
    ...
    raws.forEach((raw) => {
      let s = SignedOperation.createFromRPC(raw);
      ...
      expect(s.operations).to.be.equal(raw.operations);
