(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') {module.exports = factory(require('@pascalcoin-sbx/common'));} else if (typeof define === 'function' && define.amd) {define('@pascalcoin-sbx/epasa', ['@pascalcoin-sbx/common'], factory);} else if (typeof exports === 'object') {exports['@pascalcoin-sbx/epasa'] = factory(require('@pascalcoin-sbx/common'));} else {root['@pascalcoin-sbx/epasa'] = factory(root['@pascalcoin-sbx/common']);}
