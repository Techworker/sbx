...
| 7        | newPublicKey   | The new public key of the account.<br />Bytes with variable size prepended                                            | PublicKeyWithLength (BytesWithLength) |                                      |
...
| 8        | newPublicKey     | The new public key of the buyer (private sale).<br />Bytes with variable size prepended                               | PublicKeyWithLength (BytesWithLength) |                                      |
| 9        | lockedUntilBlock | The block number until the account is locked.<br />4byte 32bit int value                                              | Int32                                 | unsigned: true<br />endian: LE<br /> |
| 10       | fee              | The fee associated with the operation<br />A type for currency values.<br />8byte 64bit int value                     | Currency (Int64)                      | unsigned: true<br />endian: LE<br /> |
| 11       | payload_length   | The length of the payload<br />2byte 16bit int value                                                                  | Int16                                 | unsigned: true<br />endian: LE<br /> |
| 12       | payload          | The payload of the operation.<br />Bytes with variable size prepended                                                 | Bytes                                 |                                      |
...
| 7.4      | y_length       | Length of Y value<br />2byte 16bit int value                                                                          | Int16                                 | unsigned: true<br />endian: LE<br /> |
| 7.5      | y              | The X value of the public key.<br />Bytes with variable size prepended                                                | Bytes                                 |                                      |
| 8        | newPublicKey   | The new public key of the account.<br />Bytes with variable size prepended                                            | PublicKeyWithLength (BytesWithLength) |                                      |
| 9        | r_length       | Length of r.<br />2byte 16bit int value                                                                               | Int16                                 | unsigned: true<br />endian: LE<br /> |
| 10       | r              | R value of the sign operation.<br />Bytes with variable size prepended                                                | Bytes                                 |                                      |
| 11       | s_length       | Length of s.<br />2byte 16bit int value                                                                               | Int16                                 | unsigned: true<br />endian: LE<br /> |
| 12       | s              | S value of the sign operation.<br />Bytes with variable size prepended                                                | Bytes                                 |                                      |
